...
@router.get(
    ...
    responses={
        200: {
            ...
            "description": "The PDF file of the answer sheet.",
        }
    },
)
...
# ---------------------------------------------------------
@router.get(
    "/qppdfs/{collection_id}/",
    responses={
        200: {
            "content": {"application/pdf": {}},
            "description": "The PDF file of the question paper.",
        }
    },
)
def download_qppdf_by_collection(
    ...
    if not current_user.is_superuser and collection.user_id != current_user.id:
        raise HTTPException(
            status_code=403,
            detail="Not enough permissions to access this collection's data",
        )
    ...
    if not qppdf:
        raise HTTPException(
            status_code=404, detail="Question Paper PDF not found for this collection"
        )
